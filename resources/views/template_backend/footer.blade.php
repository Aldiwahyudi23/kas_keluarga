<footer class="main-footer">
    <div class="container">
        <div class="row justify-content-center">
            ...
            @if (Auth::user()->program1 == "Kas" || Auth::user()->program2 == "Tabungan")
            <div class="col-3">
                <center>
                    <a href="{{Route('pemasukan.index')}}"><i class="nav-icon fas fa-credit-card nav-icon"></i> <br> &nbsp; Bayar</a>
                </center>
            </div>
            @endif
            ...
            <div class="col-3">
                <center>
                    <a href="{{Route('pengeluaran.index')}}"><i class="nav-icon fas fa-handshake "></i> <br> &nbsp; Pinjam</a>
                </center>
            </div>
            @endif
            <div class="col-3">
