...
<section class="content card col-md-12" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        <h4><i class="nav-icon fas fa-credit-card my-1 btn-sm-1"></i> Pengeluaran</h4>
        <hr>
                        ...
                        <table id="example1" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $data->jumlah }}</td>
                                    <td>
                                        <a href="{{Route('pengeluaran.show',Crypt::encrypt($data->id))}}" class=""><i class="nav-icon fas fa-id-card">Lihat</i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
