                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title">Berita <a href=" {{route('berita.create')}} " class="btn btn-primary">Tambah</a> </h4>
                                </div>
                                    ...
                                    <table class="dt-responsive table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href=" {{route('berita.edit', $beritas->id)}} " class="btn btn-success btn-sm">Edit</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
