    ...
    <div class="row">
      <div class="col-12">
        <div class="callout callout-success alert alert-success alert-dismissible fade show">
          ...
          -Artos pembayaran pinjaman teu acan lebet kana data ! <br>
        ...
        <div class="invoice p-3 mb-3">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <p class="text-muted well well-sm shadow-none" style="margin-top: 10px;">
                Pembayaran nu ka {{$setor->lama + 1}}</b> <br>
                -Pami tos lewat ti 3 bulan mangga ingetan deui anu bersangkutan
          ...
          <div class="row no-print">
            <div class="col-12">
              <form action="{{Route('pinjaman.store')}}" method="post">
                ...
                <input type="hidden" id="pengeluaran_id" name="pengeluaran_id" value="{{ $setor->pengeluaran_id }}">
                <input type="hidden" id="pembayaran" name="pembayaran" value="{{ $setor->pembayaran }}">
                <input type="hidden" id="proses" name="proses" value="{{ $setor->status }}">
                <input type="hidden" id="foto" name="foto" value="{{ $setor->foto }}">
